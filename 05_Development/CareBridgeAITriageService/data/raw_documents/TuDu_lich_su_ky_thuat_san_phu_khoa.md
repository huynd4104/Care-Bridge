---
title: "Các kỹ thuật sản phụ khoa và hỗ trợ sinh sản được Bệnh viện Từ Dũ giới thiệu trong lịch sử hoạt động"
stage: ALL
topic: GENERAL
document_type: RESEARCH
source: "https://tudu.com.vn/vn/gioi-thieu/lich-su-hinh-thanh/nhung-thanh-tuu-moi-dat-duoc-trong-linh-vuc-chuyen-mon/"
organization: "Bệnh viện Từ Dũ"
section: "Các cột mốc kỹ thuật chuyên môn trong lịch sử bệnh viện"
source_type: "HISTORICAL_REPORT"
retrieved: "2026-08-17"
---


# Các kỹ thuật sản phụ khoa và hỗ trợ sinh sản được Bệnh viện Từ Dũ giới thiệu trong lịch sử hoạt động


> Tài liệu giới thiệu lịch sử các kỹ thuật của bệnh viện. Các nhận định về năng lực và mốc triển khai được giữ theo nguồn gốc, không phải chứng cứ về khả năng cung cấp dịch vụ hiện tại hoặc hướng dẫn sử dụng các thủ thuật cho bệnh nhân.
...
## Thao tác trên kính hiển vi đảo ngược
